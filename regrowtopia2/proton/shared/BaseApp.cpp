...
//LogMsg("**********FRAME START");
	...
	if (GetForceAspectRatio() != 0)
	{
		if (GetForceAspectRatio() > 1.0f)
		{
			...
			DrawFilledRect(0, -(GetScreenSizeYf()), GetScreenSizeXf(), GetScreenSizeYf(), MAKE_RGBA(255, 255, 255, 255));
			DrawFilledRect(0, GetScreenSizeYf()-1, GetScreenSizeXf(), GetScreenSizeYf()*3, MAKE_RGBA(255, 255, 255, 255));
		}
		else
		{
			//need to draw bars on left/right
			DrawFilledRect(-(GetScreenSizeXf()), 0, GetScreenSizeXf(), GetScreenSizeYf(), MAKE_RGBA(255, 255, 255, 255));
			DrawFilledRect(GetScreenSizeXf()-1, 0, GetScreenSizeXf(), GetScreenSizeYf(), MAKE_RGBA(255, 255, 255, 255));
		}
	}
